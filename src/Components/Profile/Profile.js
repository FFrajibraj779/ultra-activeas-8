    ...
    <div className="profile-section">
      ...
      <div className="profile-desc">
        <div>
          <p style={{ fontWeight: "bold", fontSize: "25px" }}>
            60 <small className="weight">kg</small>
          </p>
          <p className="weight">Weight</p>
        </div>
        <div>
          <p style={{ fontWeight: "bold", fontSize: "25px" }}>
            6.4 <small className="weight">fet</small>
          </p>
          <p className="weight">Height </p>
        </div>
        <div>
          <p style={{ fontWeight: "bold", fontSize: "25px" }}>
            18 <small className="weight">yrs</small>
          </p>
      ...
      <div>
        ...
        <div className="break-time">
          <button onClick={() => handleBreakTime(8)} className="day-btn">
            {" "}
            8 <span>day</span>{" "}
          </button>
          <button onClick={() => handleBreakTime(18)} className="day-btn">
            18 <span>day</span>{" "}
          </button>
          <button onClick={() => handleBreakTime(21)} className="day-btn">
            21 <span>day</span>{" "}
          </button>
          <button onClick={() => handleBreakTime(28)} className="day-btn">
            28 <span>day</span>{" "}
          </button>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="working-details">
          ...
          <p style={{ color: "#444", fontWeight: "800" }}>
            {" "}
            <span>{prevTime}</span> days
          </p>
        </div>
      </div>
